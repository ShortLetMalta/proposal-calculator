# Eleva Malta — Proposal Calculator — Quick start

Ported from the Owner Value (Italy) calculator, adapted for Malta rental income tax (15% final withholding, Art. 31D), Malta VAT (18% standard / 7% tourism reduced — selectable via the VAT-regime toggle), Malta corporate tax (35% headline, ~5% effective after the 6/7 refund), MTA licence fees and the Environmental Contribution.
