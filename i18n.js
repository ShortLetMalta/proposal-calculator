...
(function (global) {
  ...
  const STRINGS = {
    it: {
      ...
      'calc.formula':             'Formula: <b>Base tassabile = Lordo Affitti − OTA (solo affitti) − PM</b>. Il PM si calcola su <b>Ricavo Lordo Totale (Affitti + Pulizie + Assicurazione) − Pulizie − Assicurazione − OTA</b>. Le commissioni OTA si applicano su <b>Affitti + Pulizie + Assicurazione</b>.',
      ...
      'calc.s4Cedolare':          'Tassa sugli Affitti (Art. 31D, %)',
      ...
      'pdf.p6Cedolare':           'Tassa sugli affitti (Art. 31D)',
      'pdf.p6CedolareSub':        '(<span id="p6-cedolare-percent">—</span> al netto delle commissioni OTA, <br>commissioni Eleva Malta e<br>costi Pulizie+Biancheria)',
      ...
      'pdf.p7TaxNote':            '*La tassazione viene calcolata sull\'incasso al netto delle spese di pulizia, commissioni OTA (Airbnb, Booking), Prenotazioni dirette e delle spese di gestione di Eleva Malta, secondo l\'ottimizzazione fiscale impostata.',
    ...
    en: {
      ...
      'calc.formula':             'Formula: <b>Taxable base = Gross Rent − OTA (rent only) − PM</b>. PM is calculated on <b>Total Gross Revenue (Rent + Cleaning + Insurance) − Cleaning − Insurance − OTA</b>. OTA commissions apply to <b>Rent + Cleaning + Insurance</b>.',
      ...
      'calc.s4Cedolare':          'Rental Income Tax (Art. 31D, %)',
      ...
      'pdf.p6Cedolare':           'Rental Income Tax (Art. 31D)',
      'pdf.p6CedolareSub':        '(<span id="p6-cedolare-percent">—</span> net of OTA commissions,<br>Eleva Malta commissions and<br>Cleaning + Linen costs)',
      ...
      'pdf.p7TaxNote':            '*Taxation is calculated on the net amount after cleaning costs, OTA commissions (Airbnb, Booking), direct bookings and Eleva Malta management fees, according to the configured tax optimisation.',
